...
_ui_utils.apiPageLayoutToViewerModes = apiPageLayoutToViewerModes;
_ui_utils.apiPageModeToSidebarView = apiPageModeToSidebarView;
_ui_utils.approximateFraction = approximateFraction;
_ui_utils.backtrackBeforeAllVisibleElements = backtrackBeforeAllVisibleElements;
_ui_utils.binarySearchFirstItem = binarySearchFirstItem;
_ui_utils.docStyle = void 0;
_ui_utils.getActiveOrFocusedElement = getActiveOrFocusedElement;
_ui_utils.getPageSizeInches = getPageSizeInches;
_ui_utils.getVisibleElements = getVisibleElements;
_ui_utils.isPortraitOrientation = isPortraitOrientation;
_ui_utils.isValidRotation = isValidRotation;
_ui_utils.isValidScrollMode = isValidScrollMode;
_ui_utils.isValidSpreadMode = isValidSpreadMode;
_ui_utils.noContextMenuHandler = noContextMenuHandler;
_ui_utils.normalizeWheelEventDelta = normalizeWheelEventDelta;
_ui_utils.normalizeWheelEventDirection = normalizeWheelEventDirection;
_ui_utils.parseQueryString = parseQueryString;
_ui_utils.removeNullCharacters = removeNullCharacters;
_ui_utils.roundToDivide = roundToDivide;
_ui_utils.scrollIntoView = scrollIntoView;
_ui_utils.toggleCheckedBtn = toggleCheckedBtn;
_ui_utils.toggleExpandedBtn = toggleExpandedBtn;
_ui_utils.watchScroll = watchScroll;
const DEFAULT_SCALE_VALUE = "auto";
_ui_utils.DEFAULT_SCALE_VALUE = DEFAULT_SCALE_VALUE;
const DEFAULT_SCALE = 1.0;
_ui_utils.DEFAULT_SCALE = DEFAULT_SCALE;
const DEFAULT_SCALE_DELTA = 1.1;
_ui_utils.DEFAULT_SCALE_DELTA = DEFAULT_SCALE_DELTA;
const MIN_SCALE = 0.1;
_ui_utils.MIN_SCALE = MIN_SCALE;
const MAX_SCALE = 10.0;
_ui_utils.MAX_SCALE = MAX_SCALE;
const UNKNOWN_SCALE = 0;
_ui_utils.UNKNOWN_SCALE = UNKNOWN_SCALE;
const MAX_AUTO_SCALE = 1.25;
_ui_utils.MAX_AUTO_SCALE = MAX_AUTO_SCALE;
const SCROLLBAR_PADDING = 40;
_ui_utils.SCROLLBAR_PADDING = SCROLLBAR_PADDING;
const VERTICAL_PADDING = 5;
_ui_utils.VERTICAL_PADDING = VERTICAL_PADDING;
...
_ui_utils.RenderingStates = RenderingStates;
...
_ui_utils.PresentationModeState = PresentationModeState;
const SidebarView = {
    UNKNOWN: -1,
    NONE: 0,
    THUMBS: 1,
...
_ui_utils.SidebarView = SidebarView;
const TextLayerMode = {
    DISABLE: 0,
    ENABLE: 1,
    ENABLE_PERMISSIONS: 2
};
_ui_utils.TextLayerMode = TextLayerMode;
const ScrollMode = {
    UNKNOWN: -1,
    VERTICAL: 0,
    HORIZONTAL: 1,
...
_ui_utils.ScrollMode = ScrollMode;
const SpreadMode = {
    UNKNOWN: -1,
    NONE: 0,
    ODD: 1,
...
_ui_utils.SpreadMode = SpreadMode;
const CursorTool = {
    SELECT: 0,
    HAND: 1,
    ZOOM: 2
};
_ui_utils.CursorTool = CursorTool;
const AutoPrintRegExp = /\bprint\s*\(/;
_ui_utils.AutoPrintRegExp = AutoPrintRegExp;
class OutputScale {
    constructor() {
...
_ui_utils.OutputScale = OutputScale;
const InvisibleCharactersRegExp = /[\x01-\x1F]/g;
_ui_utils.animationStarted = animationStarted;
const docStyle = document.documentElement.style;
_ui_utils.docStyle = docStyle;
_ui_utils.ProgressBar = ProgressBar;
_ui_utils.animationStarted = _ui_utils.VERTICAL_PADDING = _ui_utils.UNKNOWN_SCALE = _ui_utils.TextLayerMode = _ui_utils.SpreadMode = _ui_utils.SidebarView = _ui_utils.ScrollMode = _ui_utils.SCROLLBAR_PADDING = _ui_utils.RenderingStates = _ui_utils.ProgressBar = _ui_utils.PresentationModeState = _ui_utils.OutputScale = _ui_utils.MIN_SCALE = _ui_utils.MAX_SCALE = _ui_utils.MAX_AUTO_SCALE = _ui_utils.DEFAULT_SCALE_VALUE = _ui_utils.DEFAULT_SCALE_DELTA = _ui_utils.DEFAULT_SCALE = _ui_utils.CursorTool = _ui_utils.AutoPrintRegExp = void 0;
...
_ui_utils.PDFViewerApplicationConstants = AppConstants;
